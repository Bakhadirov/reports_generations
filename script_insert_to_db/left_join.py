...
params = [pd.to_datetime(date1, date2)]
df2 = pd.read_sql(qry, engine)


# df2 = pd.read_sql("SELECT campaign,sum(event_revenue) as event_revenue_sum, "
#                   "sum(event_revenue_usd) as event_revenue_usd_sum from events "
#                   "where event_time between '2020-06-13' and '2020-06-15' "
#                   "and campaign = 'DOZ_iOS_lkl-1_purch_val-based_campaign-opt_purch-opt' "
#                   "group by campaign ", engine)
#
